...
class Ui_TestSuite(object):
    def setupUi(self, TestSuite):
        ...
        icon1 = QtGui.QIcon()
        icon1.addPixmap(QtGui.QPixmap(_fromUtf8("images/clear_log.png")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.buttonClearLog.setIcon(icon1)
        ...
        self.gridLayout_5.addWidget(self.groupBox_3, 1, 1, 3, 1)
        ...
        icon3 = QtGui.QIcon()
        icon3.addPixmap(QtGui.QPixmap(_fromUtf8("images/edit.png")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.buttonEdit.setIcon(icon3)
        ...
        icon4 = QtGui.QIcon()
        icon4.addPixmap(QtGui.QPixmap(_fromUtf8("images/remove.png")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.buttonRemove.setIcon(icon4)
        ...
        icon5 = QtGui.QIcon()
        icon5.addPixmap(QtGui.QPixmap(_fromUtf8("images/remove_all.png")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.buttonRemoveAll.setIcon(icon5)
        ...
        self.gridLayout_5.addLayout(self.verticalLayout_3, 0, 0, 2, 1)
