...
class Ui_TestSuite(object):
    def setupUi(self, TestSuite):
        ...
        TestSuite.setLayoutDirection(QtCore.Qt.LeftToRight)
        ...
        self.gridLayout_6.addLayout(self.verticalLayout_3, 0, 0, 2, 1)
        ...
        self.buttonPause = QtGui.QPushButton(self.groupBox_4)
        self.buttonPause.setEnabled(False)
        self.buttonPause.setObjectName(_fromUtf8("buttonPause"))
        self.gridLayout_4.addWidget(self.buttonPause, 0, 1, 1, 1)
        ...
        self.sliderSpeed.setMinimumSize(QtCore.QSize(80, 0))
        ...
        spacerItem1 = QtGui.QSpacerItem(123, 18, QtGui.QSizePolicy.Expanding, QtGui.QSizePolicy.Minimum)
        ...
        self.comboBoxPlayer = QtGui.QComboBox(self.groupBox_2)
        self.comboBoxPlayer.setObjectName(_fromUtf8("comboBoxPlayer"))
        self.comboBoxPlayer.addItem(_fromUtf8(""))
        self.comboBoxPlayer.addItem(_fromUtf8(""))
        self.horizontalLayout_5.addWidget(self.comboBoxPlayer)
        self.gridLayout_2.addLayout(self.horizontalLayout_5, 1, 0, 1, 2)
        spacerItem2 = QtGui.QSpacerItem(147, 19, QtGui.QSizePolicy.Expanding, QtGui.QSizePolicy.Minimum)
        ...
        self.gridLayout_2.addWidget(self.checkBoxStopWhenFailed, 2, 0, 1, 3)
        ...
        self.gridLayout_2.addWidget(self.checkBoxStopOnError, 3, 0, 1, 3)
        ...
        self.gridLayout_6.addWidget(self.groupBox_3, 1, 1, 3, 1)
        self.gridLayout_5.addWidget(self.widget_2, 0, 0, 1, 1)
        self.widget = QtGui.QWidget(self.centralwidget)
        self.widget.setMaximumSize(QtCore.QSize(16777215, 41))
        ...
        self.labelTestCollection = QtGui.QLabel(self.widget)
        self.labelTestCollection.setText(_fromUtf8(""))
        self.labelTestCollection.setObjectName(_fromUtf8("labelTestCollection"))
        self.horizontalLayout_2.addWidget(self.labelTestCollection)
        spacerItem4 = QtGui.QSpacerItem(148, 13, QtGui.QSizePolicy.Expanding, QtGui.QSizePolicy.Minimum)
        self.horizontalLayout_2.addItem(spacerItem4)
        self.label_9 = QtGui.QLabel(self.widget)
        self.label_9.setObjectName(_fromUtf8("label_9"))
        self.horizontalLayout_2.addWidget(self.label_9)
        self.labelTestCases = QtGui.QLabel(self.widget)
        self.labelTestCases.setObjectName(_fromUtf8("labelTestCases"))
        self.horizontalLayout_2.addWidget(self.labelTestCases)
        spacerItem5 = QtGui.QSpacerItem(148, 13, QtGui.QSizePolicy.Expanding, QtGui.QSizePolicy.Minimum)
        self.horizontalLayout_2.addItem(spacerItem5)
        self.label_10 = QtGui.QLabel(self.widget)
        self.label_10.setObjectName(_fromUtf8("label_10"))
        self.horizontalLayout_2.addWidget(self.label_10)
        self.imageConnectionStatus = QtGui.QLabel(self.widget)
        self.imageConnectionStatus.setText(_fromUtf8(""))
        self.imageConnectionStatus.setPixmap(QtGui.QPixmap(_fromUtf8("images/circle_red.png")))
        self.imageConnectionStatus.setObjectName(_fromUtf8("imageConnectionStatus"))
        self.horizontalLayout_2.addWidget(self.imageConnectionStatus)
    ...
    def retranslateUi(self, TestSuite):
        ...
        self.buttonPause.setText(_translate("TestSuite", "Pause", None))
        ...
        self.label_11.setText(_translate("TestSuite", "Player: ", None))
        self.comboBoxPlayer.setItemText(0, _translate("TestSuite", "ZomBot", None))
        self.comboBoxPlayer.setItemText(1, _translate("TestSuite", "Manual Mode", None))
        self.checkBoxStopWhenFailed.setText(_translate("TestSuite", "Stop when test case fails", None))
        self.checkBoxStopOnError.setText(_translate("TestSuite", "Stop on parsing error", None))
        self.groupBox_3.setTitle(_translate("TestSuite", "Log", None))
        self.buttonClearLog.setToolTip(_translate("TestSuite", "Clear log", None))
        self.label_8.setText(_translate("TestSuite", "Test Collection: ", None))
        self.label_9.setText(_translate("TestSuite", "Test Cases: ", None))
        self.labelTestCases.setText(_translate("TestSuite", "0", None))
        self.label_10.setText(_translate("TestSuite", "Connection Status:", None))
