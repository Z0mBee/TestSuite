...
class Ui_TestSuite(object):
    def setupUi(self, TestSuite):
        ...
        self.gridLayout_2.addWidget(self.checkBoxStopOnError, 2, 0, 1, 2)
        ...
        spacerItem3 = QtGui.QSpacerItem(145, 13, QtGui.QSizePolicy.Expanding, QtGui.QSizePolicy.Minimum)
        ...
        spacerItem4 = QtGui.QSpacerItem(145, 13, QtGui.QSizePolicy.Expanding, QtGui.QSizePolicy.Minimum)
    ...
    def retranslateUi(self, TestSuite):
        ...
        self.labelTestCollection.setText(_translate("TestSuite", "             ", None))
